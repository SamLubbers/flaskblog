...
from flaskblog.services import insert_blog, get_blog
...
def new_blog():
    ...
    if request.method == 'POST' and form.validate():
        insert_blog(blog_title=form.blog_title.data, blog_text=form.blog_text.data, username=request.form["current_user"])
